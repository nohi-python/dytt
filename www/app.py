...
from common.web.coroweb import add_routes, add_static
...
async def init(loop):
    ...
    add_static(app, os.path.join(os.path.dirname(os.path.abspath(__file__)), 'static'))
...
print('app.py sys.path[%s]' % (sys.path))
pwd = os.getcwd()
print("app.py  当前目录: " + pwd)
